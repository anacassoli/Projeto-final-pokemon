...
(async function init() { 
  ...
  await fetchAndCreateCard("minun"); 
  await fetchAndCreateCard("raichu"); 
  await fetchAndCreateCard("mareep"); 
  await fetchAndCreateCard("ampharos"); 
  await fetchAndCreateCard("shinx"); 
  await fetchAndCreateCard("pachirisu"); 
  await fetchAndCreateCard("voltorb"); 
  await fetchAndCreateCard("luxray"); 
  await fetchAndCreateCard("luxio"); 
  await fetchAndCreateCard("plusle"); 
  await fetchAndCreateCard("manectric"); 
})();
